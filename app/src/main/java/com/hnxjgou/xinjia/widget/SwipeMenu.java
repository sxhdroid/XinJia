...
//                Log.e("scroll - startX - endX",""+startX+" "+endX);
                ...
                ViewCompat.postOnAnimation(SwipeMenu.this,this);
            }
        }
...
//                Log.e("curX",""+curX);
    ...
    public static class LayoutParams extends MarginLayoutParams{
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.swipe_menu);
            itemType = a.getInt(R.styleable.swipe_menu_layout_itemType,-1);
            a.recycle();
        }
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:{
                    ...
                    SwipeMenu pointItem = null;
                    //首先知道ev针对的是哪个item
                    View pointView = findTopChildUnder(rv,(int)x,(int)y);
                    if(pointView==null || !(pointView instanceof SwipeMenu)){
                        //可能是head view或bottom view
                        pointOther = true;
                    }else
                        pointItem = (SwipeMenu) pointView;
